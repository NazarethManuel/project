                ...
                <br>
                    ...
                    <br>
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.book.create.index') }}">Cadastrar Novo Livro </a></li>
                                        ...
                                        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                                            <li class="nav-item dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('admin.book.show', $books->id)}}" class="dropdown-item"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('admin.book.destroy', $books->id)}}" class="dropdown-item"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
